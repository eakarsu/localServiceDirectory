...
APP_PORT="${PORT:-3000}"
DB_NAME="local_service_directory"

echo "=========================================="
echo "  Local Service Directory - Startup Script"
echo "=========================================="
echo ""
...
export NEXTAUTH_SECRET="${NEXTAUTH_SECRET:-localservices-dev-secret-change-in-production}"
...
echo ""
echo "=========================================="
echo "  Starting Local Service Directory on port ${APP_PORT}"
echo "=========================================="
echo ""
...
echo "  Business: plumber@example.com / password123"
