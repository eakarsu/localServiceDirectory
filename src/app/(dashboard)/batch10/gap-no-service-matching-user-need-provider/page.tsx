...
// Batch 10 page: "No service matching (user need → provider) chatbot" (ai-gap) — localServiceDirectory
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-service-matching-user-need-provider";
const LABEL = "No service matching (user need → provider) chatbot";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-service-matching-user-need-provider";

export default function NoServiceMatchingUserNeedProviderPage() {
