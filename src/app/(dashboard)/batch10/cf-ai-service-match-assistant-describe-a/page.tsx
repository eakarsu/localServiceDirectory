...
// Batch 10 page: "AI service-match assistant (describe a job, get vetted matches + quotes)" (cfs) — localServiceDirectory
'use client';
import { useEffect, useState } from 'react';

const SLUG = "ai-service-match-assistant-describe-a";
const LABEL = "AI service-match assistant (describe a job, get vetted matches + quotes)";
const SECTION = "cfs";
const API_PATH = "/api/cf-ai-service-match-assistant-describe-a";

export default function AiServiceMatchAssistantDescribeAPage() {
