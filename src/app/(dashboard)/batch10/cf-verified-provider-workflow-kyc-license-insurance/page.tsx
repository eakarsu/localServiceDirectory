...
// Batch 10 page: "Verified-provider workflow (KYC, license + insurance proof, background check)" (cfs) — localServiceDirectory
'use client';
import { useEffect, useState } from 'react';

const SLUG = "verified-provider-workflow-kyc-license-insurance";
const LABEL = "Verified-provider workflow (KYC, license + insurance proof, background check)";
const SECTION = "cfs";
const API_PATH = "/api/cf-verified-provider-workflow-kyc-license-insurance";

export default function VerifiedProviderWorkflowKycLicenseInsurancePage() {
