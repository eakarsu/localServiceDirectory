...
// Batch 10 page: "No multi-language support" (nonai-gap) — localServiceDirectory
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-multi-language-support";
const LABEL = "No multi-language support";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-multi-language-support";

export default function NoMultiLanguageSupportPage() {
