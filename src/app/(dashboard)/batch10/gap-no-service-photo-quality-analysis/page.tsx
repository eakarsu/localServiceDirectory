...
// Batch 10 page: "No service-photo quality analysis" (ai-gap) — localServiceDirectory
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-service-photo-quality-analysis";
const LABEL = "No service-photo quality analysis";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-service-photo-quality-analysis";

export default function NoServicePhotoQualityAnalysisPage() {
