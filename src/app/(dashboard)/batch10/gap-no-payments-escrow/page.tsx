...
// Batch 10 page: "No payments / escrow" (nonai-gap) — localServiceDirectory
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-payments-escrow";
const LABEL = "No payments / escrow";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-payments-escrow";

export default function NoPaymentsEscrowPage() {
