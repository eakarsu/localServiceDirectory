...
// Batch 10 page: "No dispute resolution copilot" (ai-gap) — localServiceDirectory
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-dispute-resolution-copilot";
const LABEL = "No dispute resolution copilot";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-dispute-resolution-copilot";

export default function NoDisputeResolutionCopilotPage() {
