...
// Batch 10 page: "No public API for partners" (nonai-gap) — localServiceDirectory
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-public-api-for-partners";
const LABEL = "No public API for partners";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-public-api-for-partners";

export default function NoPublicApiForPartnersPage() {
