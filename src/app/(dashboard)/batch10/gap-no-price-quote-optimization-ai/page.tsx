...
// Batch 10 page: "No price-quote optimization AI" (ai-gap) — localServiceDirectory
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-price-quote-optimization-ai";
const LABEL = "No price-quote optimization AI";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-price-quote-optimization-ai";

export default function NoPriceQuoteOptimizationAiPage() {
