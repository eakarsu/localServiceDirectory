...
// Batch 10 page: "No emergency / on-demand dispatch" (nonai-gap) — localServiceDirectory
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-emergency-on-demand-dispatch";
const LABEL = "No emergency / on-demand dispatch";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-emergency-on-demand-dispatch";

export default function NoEmergencyOnDemandDispatchPage() {
